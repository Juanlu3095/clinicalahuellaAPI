...
const Post = z.object({
  slug: z.string({ required_error: 'El campo slug es requerido.', invalid_type_error: 'El campo slug debe ser un string.' }).min(1, 'El campo slug no puede estar vacío.'),
  titulo: z.string({ required_error: 'El campo titulo es requerido.', invalid_type_error: 'El campo titulo debe ser un string.' }).min(1, 'El campo título no puede estar vacío.'),
